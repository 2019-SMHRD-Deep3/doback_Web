                  ...
                  <table id="example-table-1" width="100%"
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><button onclick="print(<%=edtoArr.get(i).getAllsim()%>)">보기</button></td>
                        </tr>
                     </tbody>
                ...
                function drawChart() {
                   var data = google.visualization.arrayToDataTable([
                         [ "Element", "Density", {
                          ...
                          [ "chic", parseInt(word3), "silver" ],[ "문장1", parseInt(sentence1), "silver" ],
                          [ "문장2", parseInt(sentence2), "gold" ] ]);
