						...
						<nav>
							<ul class="primary-nav">
								<li><a href="#assets" class="btn-white btn-small"
									style="padding-right: 19px; padding-left: 19px;">소개</a></li>
			...
			<section class="hero-strip section-padding">
				<div class="container">
					<div class="col-md-12 text-center">
						...
						<a href="File.jsp" data-toggle="modal" data-target="#file"
							id=filebtn class="btn btn-ghost btn-accent btn-large" onClick="javascript:runQuery()">Click</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 rightcol">
                    <h3 id="warning">파일 업로드 시 주의 할 점</h3>
					<h5>1.파일은 반드시 ".wav" 파일로 업로드 해주세요.</h5>
					<h5>2.단어 하나 하나, 문장 하나 하나 세부적인 결과를 보여드리기 위해 파일 녹음을 각각 순서대로 업로드 해주세요.</h5>
					<h5>3.정확한 측정을 위해 조용한 곳에서 녹음한 파일을 업로드 해주세요.</h5>
					<h5>4.틀리다고 짜증내면 신고합니다. 주의하세요!</h5>
                </div>
            </div>
